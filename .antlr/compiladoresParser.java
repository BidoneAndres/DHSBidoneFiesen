...
public class compiladoresParser extends Parser {
	...
	public static final int
		...
		GE=20, WS=21, ID=22, OTRO=23, FOR=24, ORR=25, AND=26, NOMBRE=27;
	public static final int
		RULE_s = 0, RULE_programa = 1, RULE_instrucciones = 2, RULE_instruccion = 3, 
		RULE_asignacion = 4, RULE_declaracion = 5, RULE_iwhile = 6, RULE_bloque = 7, 
		RULE_opal = 8, RULE_exp = 9, RULE_operador = 10, RULE_e = 11, RULE_term = 12, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"s", "programa", "instrucciones", "instruccion", "asignacion", "declaracion", 
			"iwhile", "bloque", "opal", "exp", "operador", "e", "term", "t", "factor", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"GE", "WS", "ID", "OTRO", "FOR", "ORR", "AND", "NOMBRE"
		};
	}
